package com.sc.kanak.auth.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("kanakAuth");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("kanakAuth");
        ...
        config.getMapConfigs().put("com.sc.kanak.auth.domain.*", initializeDomainMapConfig(jHipsterProperties));
